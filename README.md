...
Functions and supported models are listed in the documentation for the Julia package [here](https://roboticexplorationlab.org/PinnZoo/build/index.html). Some of the Julia code is now compatible with ForwardDiff.jl!
